...
resource "proxmox_virtual_environment_vm" "first_vm" {
  name      = "vm1-lefevret"
...
resource "proxmox_virtual_environment_vm" "third_vm" {
  name      = "vm3-lefevret"
  node_name = local.node_name
  pool_id   = local.pool_id
